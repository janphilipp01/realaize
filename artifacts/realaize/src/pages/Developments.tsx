...
import type { GeverkPosition, GeverkCategory, ActivityEntry, Unit, UsageType } from '../models/types';
      ...
      <div className="mb-6">
        <Tabs
          tabs={[
            ...
            { key: 'rentroll', label: 'Mieterliste', count: (dev.units || []).length },
      ...
      {activeTab === 'rentroll' && (
        <div className="animate-fade-in space-y-4">
          <div className="flex items-center justify-between mb-2">
            <div>
              <SectionHeader title="Mieterliste" />
